...
// [[Rcpp::export]]
List update_delta_c_d_rjmcmc(arma::mat delta, arma::mat gamma,
  ...
  arma::cube c_imk = arma::cube(v.n_rows, max(K), S + S_star);
  // arma::mat delta = arma::mat(v.n_rows, S  + S_star);
  // arma::mat gamma = arma::mat(v.n_rows, S  + S_star);

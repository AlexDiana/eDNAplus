...
for (sim in 1:nsims) {
  ...
  save(ldiff_accuracy, file = "highlowsim_3.rda")
}
...
ldiff_accuracy <- ldiff_accuracy[,1:sim]

ldiff_accuracy <- apply(ldiff_accuracy, 1, mean)
